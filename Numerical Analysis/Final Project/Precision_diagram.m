    ...
    h_step = [0.1 0.01 0.025 0.05 0.005 0.001 0.0001 0.00005 ] ;
    ...
    plot(cpu_time(:,1),error_last(:,1),'b-o')
    hold on
    plot(cpu_time(:,2),error_last(:,2),'r-o')
    plot(cpu_time(:,3),error_last(:,3),'g-x')
    title(" Precision Diagram for The three Methods")
    xlabel("CPU Time")
    ylabel(" Error at Last Step")
    legend( {"Adams-Bashforth 3 step",...
        "BDF 3 step", "Adams-Moulton 2 step"},'FontSize',22);
